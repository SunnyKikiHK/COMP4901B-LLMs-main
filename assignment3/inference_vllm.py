...
def format_prompts(
    ...
    for question in questions:
        prompt = FEW_SHOT_PROMPT.format(question=question) if use_few_shot else ZERO_SHOT_PROMPT.format(question=question)

        if use_chat_template is True and tokenizer is not None:
            messages = []
